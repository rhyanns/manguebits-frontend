...
function CardComunidade({
  ...
  return (
    <div
      className={`${styles["shadow-lg"]} ${styles["bg-green-400"]} ${styles.flex} ${styles["flex-col"]} ${styles["items-center"]} ${styles["justify-center"]} ${styles["w-20"]} ${styles["h-6"]} ${styles["p-05"]} ${styles["radius-8"]} ${styles.fontPixel}`}
    >
      <div
        className={`${styles.flex} ${styles["align-center"]} ${styles["w-full"]} ${styles["gap-1"]} ${styles["h-90"]}`}
      >
        ...
        <div
          className={`${styles.flex} ${styles["h-full"]} ${styles["align-center"]} ${styles["justify-center"]} ${styles["gap-07"]}`}
        >
          <img
            className={`${styles["w-2-4"]} ${styles["h-2-4"]} ${styles["radius-full"]}`}
            src={avatarUrl}
            alt={`Avatar de ${nome}`}
          />
          ...
          <div className={`${styles.flex} ${styles["flex-col"]}`}>
            ...
            <span
              ...
              className={`${styles["font-bold"]} ${styles["h-10"]} ${styles["hidden"]} ${styles["cursor-pointer"]} ${styles["hover-underline"]}`}
            >
              {nome}
            </span>

            <span
              className={`${styles["color-gray-500"]} ${styles["h-90"]} ${styles["descricao"]}`}
            >
              {descricao}
            </span>
          </div>
